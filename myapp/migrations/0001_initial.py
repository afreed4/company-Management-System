# Generated by Django 5.0.4 on 2024-09-02 10:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_type', models.CharField(choices=[('Admin', 'Administrator'), ('HR', 'HR'), ('Manager', 'Manager'), ('Employee', 'Employee')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.companymanagement')),
            ],
        ),
    ]
